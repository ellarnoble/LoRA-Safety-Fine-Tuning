"""
Run IFEval + MMLU across the base Falcon-7B model, full FT model and all LoRA
...
Skips any condition whose results already exist
"""
...
BASE_MODEL = str(BASE_MODEL_ROOT / "falcon7b")
FULL_FT_MODEL = FULL_FT_ROOT / "falcon_full"
